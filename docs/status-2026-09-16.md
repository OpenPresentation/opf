...
| Developer starting path | [Quickstart](quickstart.md) plus [compatibility matrix](compatibility-matrix.md). Prove with `pnpm test:developer-quickstart` (fresh registry install). |
