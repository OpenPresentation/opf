...
editor 0.7.1, all Node 24. The developer-ready milestone is **not** complete.
...
| Public-site adoption | Still [issue 88](https://github.com/OpenPresentation/opf/issues/88). Open. |
...
| Native PowerPoint | Still [issue 87](https://github.com/OpenPresentation/opf/issues/87). Serialization/`toPptx` are not Office acceptance. |
