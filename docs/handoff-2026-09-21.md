...
The [current checkpoint](evidence/author-source-acceptance-20260921/README.md),
...
| --- | --- | --- |
| opf | `c3e35b92e53d12764f9b1b7487ccfb7325d5c1aa` | PR93/97/98/99/100 accepted; current entrypoints and evidence checkpoints corrected; pre/post-merge CI green |
...
Core PR93/97/98/99/100 passed their pre-merge and post-merge CI gates, including the
applicable OPF, CLI platform and coordinated installed-package/browser checks.
Core100's post-merge runs are [35624778901](https://github.com/OpenPresentation/opf/actions/runs/35624778901)
and [35624778863](https://github.com/OpenPresentation/opf/actions/runs/35624778863);
the [release receipt](evidence/author-source-acceptance-20260921/core100/release-receipt.json)
records the clean primary checkout and tested/accepted tree equality.
...
The [current issue88 receipt](evidence/author-source-acceptance-20260921/issue88-app53-diagnosis-updated.json) remains OPEN. The canonical evidence retains 31 saved downloads, 28 literal-byte JSON checks, source/deployment bindings and five reviewed screenshots. Remaining readiness, preset/source preservation and compatibility work still require correction and fresh acceptance.

The [postmerge trace diagnosis](evidence/author-source-acceptance-20260921/inspector-share-diagnosis/REPORT.md) also proves that automatic share-hash sync briefly published the starter while imported source was current. The exact queued/deferred mechanism is inferred; permanent persistence and an actual refresh were not observed. The separate Inspector publication guard is being prepared and is not released.
