...
- The representative deck for [the published-package quickstart](quickstart.md) lives at [`docs/quickstart/developer-quickstart.opf.json`](quickstart/developer-quickstart.opf.json) so `@openpresentation/opf/examples` and the renderer golden corpus stay aligned at 127 decks.
