...
| Tables | Cell and structure editing; core 0.5.0 adds canonical rich cells and headers | Renderer/PPTX 0.3.0 and editor 0.2.0 provide rich-cell measurement, SVG tracing, formatting/typing/undo and native PPTX run export with regression coverage; rich native import, cell decoration, advanced interactions and native PowerPoint parity remain |
