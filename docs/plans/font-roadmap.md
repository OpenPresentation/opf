...
The coordinated migration to [Node 24](ecosystem-objective-2026-09-09.md#accepted-runtime-simplification--september-10-2026) is complete. Subsequent font/layout verification uses Node 24 while retaining distinct browser and native-platform coverage. Historical dual-runtime results below remain evidence, not a requirement to repeat both runtimes indefinitely.
