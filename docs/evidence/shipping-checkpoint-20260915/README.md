...
| [openpresentation-site](https://github.com/Data-Advantage/openpresentation-site) | `main`: `6d41bf86af553fe94092ff361347114a8dca20aa` | Homepage/playground JSON and preview editing, code-editor behavior, contextual options and improved layout grouping are merged and deployed. PR36 updates browser-test timing and publication history. |
...
- [ ] Merge [website PR36](https://github.com/Data-Advantage/openpresentation-site/pull/36) after its current checks pass. This is a test/history change, not new runtime styling.
