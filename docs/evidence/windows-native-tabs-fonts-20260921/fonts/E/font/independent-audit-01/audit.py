...
REPORT_OUT = AUDIT_DIR / "report.json"
EXPECTED_FACES = {
...
def audit() -> dict:
    ...
    helper_flags_ok = "AddFontResourceExW($fontPath,0" in helper_text and "RemoveFontResourceExW((Join-Path $EvidenceRoot $face.file),0" in helper_text and "$succeeded" in helper_text
