...
OUT = pathlib.Path(__file__).resolve().parent / "audit-report.json"
TOLERANCE = 0.02
PERSISTENCE_NUMERIC = [
...
def main() -> None:
    ...
    checks = {
        ...
        "verifierAndHelperExternalAndSnapshotsMatch": all(v["externalMatches"] and v["snapshotMatches"] and v["externalAndSnapshotEqual"] for v in input_results.values()),
