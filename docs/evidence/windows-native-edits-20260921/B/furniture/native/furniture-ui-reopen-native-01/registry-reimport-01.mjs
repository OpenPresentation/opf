...
const reportPath = path.join(here, 'registry-reimport-01.analysis.json');
const importPath = path.join(here, 'registry-reimport-01.opf.json');
const savedPptxPath = path.join(here, 'native-furniture-control.pptx');
const inputPptxPath = path.join(here, 'input.pptx');
