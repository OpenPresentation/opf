...
const root=path.dirname(fileURLToPath(import.meta.url)),major=process.versions.node.split('.')[0],output=path.join(root,'card-layout-final-checks',`browser-node${major}`);
