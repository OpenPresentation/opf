...
| --- | --- | --- |
| OpenPresentation/opf | codex/styled-table-release-sync-20260908 | This handoff and verification scripts; draft release-sync PR |
| OpenPresentation/opf-render | codex/styled-table-cells-20260908 | [PR #6](https://github.com/OpenPresentation/opf-render/pull/6), head `80ae8bb923390f695a6f19db99877f6c4ee72ae0` |
...
On latest head `80ae8bb`, focused styled-table regressions pass on Node20/24 and renderer syntax checks pass. Full suite/raster baseline, renewed CI/review, and a new packed candidate remain required. The previous tarball integrity is obsolete. Review threads were left open for evidence-based follow-up. PR description records these distinctions.
