...
Local-only CLI source for OPF. This is not currently a published package, and it is not a hosted-service client. It does not render, parse, generate, call remote APIs, fetch catalogs, emit telemetry, or use AI.
