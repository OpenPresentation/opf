...
function assetsFor(spec, index) {
  ...
  for(const [name,png]of Object.entries(galleryArtwork(spec.org,index,{dark:darkGalleryBackground(index)}))){
    assets[name]={...assets[name],src:`data:image/png;base64,${png.toString('base64')}`,mediaType:'image/png',description:'Original abstract demonstration artwork for this fictional organization. MIT licensed with OpenPresentation/opf; generated by scripts/gallery-artwork.mjs (v1). No fonts or external images are used.'};
  }
  return assets;
}
